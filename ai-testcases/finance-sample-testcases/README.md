...
* **Why important?** Although one could ask both objective and subjective questions in general, all questions above are subjective. The answers could potentially cause harms in all the four indentified cateogries from the book: HC1-incorrect-info, HC2-opinion-manipulation, HC3-unstable-extrauserinfo, HC4-incomprehensible-ai.
